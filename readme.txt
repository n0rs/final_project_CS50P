...
EasyStock is a program in a file called final_project_CS50P.py that calls an API to analyze stock data. This API contains around 12500 stocks and ETFs traded at the US stock exchange.
...
This function is tested in test_final_project.py by mocking potential input and checking if the function returns it correctly.
